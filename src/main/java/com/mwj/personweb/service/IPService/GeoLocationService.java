package com.mwj.personweb.service.IPService;
...
/** @Auther: munjie @Date: 2019/3/16 11:00 @Description: */
@Component
public class GeoLocationService {
  ...
  public GeoLocationService() {
    String dataFile = "/usr/local/GeoLite2-City.mmdb";
  ...
  private GeoLocation getLocationV2(String ipAddress) {
    ...
    if (null == reader) {
      ...
      try {
        ...
        e.printStackTrace();
        logger.error("IP地址解析异常", e.getMessage());
